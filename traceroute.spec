...
%build
make %{?_smp_mflags} CFLAGS="$RPM_OPT_FLAGS -fno-strict-aliasing" LDFLAGS=""
...
%changelog
* Fri May 21 2010 Jiri Skala <jskala@redhat.com> - 3:2.0.14-2
- Resolves: #594369 - RPMdiff run failed

* Tue Apr 27 2010 Jiri Skala <jskala@redhat.com> - 3:2.0.14-1
- Resolves: #586109 - traceroute don't like -l flowlabel, -t priority and -g nexthop option
- update to latest upstream

* Wed Jan 06 2010 Jiri Skala <jskala@redhat.com> - 3:2.0.12-4
- Related: rhbz#543948
- fixed Sources0

* Mon Nov 30 2009 Dennis Gregorovic <dgregor@redhat.com> - 3:2.0.12-3.1
- Rebuilt for RHEL 6
